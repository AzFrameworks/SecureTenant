<#
.SYNOPSIS
    Creates the EUD CSM 2606 Autopilot Deployment Profile in Microsoft Intune.
.DESCRIPTION
    ...
    to the EUD-Global-Devices group. The script is self-sufficient and requires
    no external files or specific execution path.
.EXAMPLE
    .\Import-AutopilotProfileEUD.ps1
.EXAMPLE
    .\Import-AutopilotProfileEUD.ps1 -WhatIf
#>
...
$profileName  = "EUD 2606 Autopilot Profile"
$scopeTagName = "EUD"
$groupName    = "EUD-Global-Devices"
